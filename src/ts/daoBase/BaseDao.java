...
public class BaseDao<T, PK extends Serializable> extends HibernateDaoSupport
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<T> findBy(String orderBy, boolean isAsc,
	...
	public List<T> findBy(String propertyName, Object value, String orderBy,
		...
		// return createCriteria(orderBy, isAsc, Restrictions.eq(propertyName,
		// value)).list();
	}

	@Override
	public List<T> findLike(String propertyName, Object value, String orderBy,
			boolean isAsc) {
		Assert.hasText(propertyName);
		Assert.hasText(orderBy);
